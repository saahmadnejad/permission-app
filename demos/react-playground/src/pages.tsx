...
import { ALL_PERMISSIONS, registerDemoNodes } from 'permission-visibility-demo-data';
import { PermissionProvider, Show, getStore, usePermission } from './permissions';
  ...
  return (
    <PermissionProvider>
      <header>
        ...
        <p>Same <code>permission-visibility-core</code> as Angular — parent shown iff itself allowed and a child visible.</p>
